...
FILE_DESCRIPTIONS = {
    ...
    "recommendation_rationale.csv": "Scenario shortlist rationale combining ranking, stability, evidence risk, implementation effort, and operational ranks.",
    ...
    "sandbox_source_matrix.csv": "Official source URLs used by the sandbox evaluation dataset.",
    "sandbox_threat_coverage.csv": "Threat-to-control coverage by sandbox option.",
