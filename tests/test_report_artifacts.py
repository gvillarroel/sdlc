...
class ReportArtifactsTest(unittest.TestCase):
    ...
    def test_final_global_report_exists(self):
        ...
        self.assertIn("docs/assets/final-report-evidence-pipeline.svg", text)
        self.assertIn("docs/assets/final-report-decision-lanes.svg", text)
        self.assertIn("docs/assets/final-report-artifact-coverage.svg", text)
